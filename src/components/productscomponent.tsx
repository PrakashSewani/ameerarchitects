...
export default function ProductsComponent() {
  ...
  return (
    <div className="wrapper">
      ...
      <div onClick={()=>navigate("Dubai-Land-Snowdome")} className="project-container">
      ...
      <div onClick={()=>navigate("Burj-Dubai-Lake-Developement")} className="project-container">
          <div className="image-container">
            <div className="images">
              <img
        ...
        <div onClick={()=>navigate("VIP-Waterfront")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("Air-Thane")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("Ananta-Towers")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("Lions-Park")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("North-Gate")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("Worli-Tower")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("ETA-SEMS-School")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("Bahrain-TradeCenter")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("August-House")} className="project-container">
          <div className="image-container">
            <div className="images">
        ...
        <div onClick={()=>navigate("Residential-Complex")} className="project-container">
          <div className="image-container">
            <div className="images">
